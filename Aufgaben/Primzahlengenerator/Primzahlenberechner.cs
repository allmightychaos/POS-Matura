...
namespace SimpleThreadApp
{
    public class Primzahlenberechner
    {
        ...
        private static List<int> allPrims = new List<int>();

        public int BerechnePrimzahl(int userThreads, int userPrimMax)
        {
            int threadsCount = userThreads;             // Anzahl an Threads
            int primMax = userPrimMax;       // Maximale Zahl zum überprüfen
            ...
            return allPrims[allPrims.Count - 1];
        }
